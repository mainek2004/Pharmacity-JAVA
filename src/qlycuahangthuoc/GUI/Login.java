...
import qlycuahangthuoc.GUI.mainform;
import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
import java.sql.*;
import qlycuahangthuoc.DAO.KetNoiCSDL;
import qlycuahangthuoc.GUI.QlyHoaDon;
...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try (Connection con = KetNoiCSDL.getConnection();
             PreparedStatement ps = con.prepareStatement("SELECT * FROM TAIKHOAN WHERE UserName = ? AND Pass = ?")) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
                    ...
                    if (loaitk == 1) {
                        ...
                        QlyHoaDon nhanVienForm = new QlyHoaDon();
